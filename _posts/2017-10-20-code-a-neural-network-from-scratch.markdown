...
The post is not going to use Google’s Tensorflow library (the next post will), but you will get a good sense about Neural Network by playing a few examples in the [Tensorflow playground](http://playground.tensorflow.org) site:
